...
const MOBILE_JOURNEYS =
  /(configurator|cart|order|admin-auth|admin-orders|discounts)\.spec\.ts$/;
...
const DESKTOP_JOURNEYS =
  /(configurator|cart|order|admin-auth|admin-orders|supplier-pdf|admin-products|discounts)\.spec\.ts$/;
