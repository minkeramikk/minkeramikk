 ...
 */
const ORDER_SELECT =
  "id, code, customer_name, email, phone, address, zipcode, country, message, locale, status, internal_notes, paid_at, tracking_code, discount_ratified_at, created_at, updated_at, " +
