 ...
 */
const ORDER_SELECT =
  "id, code, customer_name, email, phone, address, zipcode, country, message, locale, status, internal_notes, paid_at, tracking_code, created_at, updated_at, " +
  "order_items ( id, supplier_id, supplier_name_snapshot, product_name_snapshot, price_cents_snapshot, currency_snapshot, quantity, config_code, config_snapshot, product_id, products ( image, slug, product_attributes ( key, value_num ) ) )";
