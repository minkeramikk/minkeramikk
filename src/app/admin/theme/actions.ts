 ...
 * the service-role key is never used here. Zod-validated for hex format. The
 * WCAG AA contrast is advisory-only (shown in the editor) — not enforced here,
 * so any colour choice can be saved.
 */
