...
name: reviewer
description: >
  Review agent di minkeramikk: revisiona il diff di una PR contro la card e la checklist di
  processo (DELIVERY §6). Solo su codice che NON ha scritto lui. Input: branch o diff + card.
  Output: commenti per gravità, i differiti in forma registro, o APPROVE esplicito.
