...
name: frontend
description: >
  Agente frontend di minkeramikk: schermate, componenti e orchestrazione nelle zone frontend di
  AGENTS.md §Architettura, sempre sui contratti che il backend espone e sul design system. Usalo
  per i task di una card che toccano la UI. Non tocca dominio, implementazioni dati o schema.
