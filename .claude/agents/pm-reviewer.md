...
name: pm-reviewer
description: >
  Delegato del PM nella sessione dev di minkeramikk: rivede il piano di una card COLD contro la card e
  il codice, approva se i controlli meccanici passano, altrimenti elenca cosa manca; escalation al
  PM umano solo per le decisioni di prodotto. Subagent fresco, mai chi ha scritto il piano. Solo lettura.
