...
name: backend
description: >
  Agente backend di minkeramikk: dominio, contratti verso il frontend, implementazioni, schema
  dati, seed e test. Usalo per i task di una card che toccano le zone backend di AGENTS.md
  §Architettura. Consegna contratti tipizzati che il frontend consuma. Non tocca le zone frontend.
